...
from gps_visual.ghost_matching import bbox_iou, project_xy_to_uv
from gps_visual.gps_integrity import GpsIntegrityState
from gps_visual.landmark_database import LandmarkDatabase
from gps_visual.yolo_onnx import YoloOnnxDetector
...
class SensorFusionNode(Node):
    def __init__(self) -> None:
        ...
        self.declare_parameter("landmark_sqlite", "/tmp/gps_visual_landmarks.sqlite")
